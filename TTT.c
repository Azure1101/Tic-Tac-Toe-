/*	
	KELOMPOK A11
	-FANNY PUTRIA AGUSTINA-201524007
	-NABIILAH NADA ISWARI-201524020
*/
#include <stdio.h>
#include <stdlib.h>
#include <conio.h>
...
void PilihanKesulitan3x3();
void gameMode3x3();
void memilihsimbol3x3();
void letsPlay3x3();
...
void gameMode5x5();
void memilihsimbol5x5();
void letsPlay5x5();
int notLetHumanWin5x5();
void main5x5();
void humanTurn5x5();
void computerTurn5x5();
void player2Turn5x5();
int winPossible5x5();
void displayBoard5x5();
int checkWinner5x5();
...
void gameMode7x7();
void memilihsimbol7x7();
void letsPlay7x7();
int notLetHumanWin7x7();
void main7x7();
void humanTurn7x7();
void computerTurn7x7();
void player2Turn7x7();
int winPossible7x7();
void displayBoard7x7();
int checkWinner7x7();
...
int main()
{
	...
	//Author		: Nabiilah Nada Iswari dan Fanny Putria Agustina
	//Source		: Mirza Abdul wadood Baig 
	system ("cls");
	system ("color E");
	int start;
	printf("\n\t\t\t+-----------------------------------------------------------------------+\t\t\t\n");
...
void gameMode3x3()
{
	...
	//Author		: Nabiilah Nada Iswari, Fanny Putria Agustina, dan Dimas Wisnu Saputro
	//Source		: Mirza Abdul wadood Baig 
	system("cls");
	system ("color 4");
    int n;
...
void computerTurn5x5()
{
	...
	//Final State	: Komputer menginputkan langkah
	//Author		: Nabiilah Nada Iswari dan Fanny Putria Agustina
	//Source		: Mirza Abdul wadood Baig, Dimas Wisnu Saputro
	system ("color 2");
	int option=1;
    printf("\n Computer's turn\n");
    if(kesul1tan==3){
    	option = winPossible5x5();	
	}
    if(option != 0)
    {
        int option2=1;
        if(kesul1tan>=2){
        	option2 = notLetHumanWin5x5(); 
		} 
...
void gameMode5x5()
{
	...
	//Initial State	: Program belum berjalan
	//Final State	: Terlihat pilihan menu di layar, dimana user bisa memilih modul mana yang ingin dieksekusi
	//Author		: Nabiilah Nada Iswari, Dimas Wisnu Saputro
	//Source		: Mirza Abdul wadood Baig 
	system("cls");
	system ("color 2");
    int n;
...
void computerTurn7x7()
{
	...
	//Initial State	: Program belum berjalan
	//Final State	: Komputer menginputkan langkah
	//Author		: Nabiilah Nada Iswari, Fanny Putria Agustina, Dimas Wisnu Saputro
	//Source		: Mirza Abdul wadood Baig 
    system ("color 1");
	int option=1;
    printf("\n Computer's turn\n");
    if(kesulit4n==3){
    	option = winPossible7x7();	
	}
    if(option != 0)
    {
        int option2=1;
        if(kesulit4n>=2){
        	option2 = notLetHumanWin7x7();
		} 
